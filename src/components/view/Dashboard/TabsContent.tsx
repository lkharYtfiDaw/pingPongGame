...
export function TabsPlayContent({ params }: TabsContentProps) {
  return (
    <div className='flex xl:flex-col 2xl:w-80 w-full px-8 items-center justify-around 2xl:justify-between xl:h-96 bg-[#242424] hover:bg-tab-gradient rounded-xl py-6 my-2 cursor-pointer'>
      <div className='w-56   '>
